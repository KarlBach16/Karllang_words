...
start_ui_label: "UI 언어",
    ...
    start_with_apple: "Apple로 계속하기",
    start_with_google: "Google로 계속하기",
    start_as_guest: "게스트로 시작",
    start: "시작",
...
start_screen_hint: "",
    ...
    account_title: "계정",
    account_status_guest: "게스트 모드",
    account_status_signed_in: "로그인됨",
    account_status_local_only: "학습 기록은 이 기기에 저장됩니다.",
    account_status_sync_ready: "클라우드 동기화 준비 완료.",
    account_sign_in: "로그인",
    account_sign_in_google: "Google로 로그인",
    account_sign_in_apple: "Apple로 로그인",
    account_sign_out: "로그아웃",
    account_signing_in: "로그인 중...",
    account_sign_in_coming_soon: "로그인은 다음 단계에서 추가됩니다.",
    account_sync_ready: "클라우드 동기화 준비 완료.",
    account_sync_checking: "동기화 데이터를 확인 중입니다.",
    account_sync_upload_detail: "현재 기기의 학습 기록을 클라우드에 올립니다.",
    account_sync_download_detail: "클라우드의 학습 기록을 이 기기로 가져옵니다.",
    account_sync_conflict_detail: "첫 동기화에 사용할 학습 기록을 선택하세요.",
    account_sync_changed_detail: "클라우드와 이 기기의 학습 기록이 다릅니다. 유지할 데이터를 선택하세요.",
    account_sync_check: "동기화 확인",
    account_sync_checking_short: "확인 중",
    account_sync_up_to_date: "최신 상태",
    account_sync_section_title: "동기화",
    account_sync_upload: "기기 기록 올리기",
    account_sync_download: "클라우드 기록 가져오기",
    account_sync_working: "동기화 중...",
    account_sync_done: "동기화 완료.",
...
en: {
    ...
    start_as_guest: "Continue as Guest",
    start: "Start",
    ...
    account_status_guest: "Guest mode",
    account_status_signed_in: "Signed in",
    account_status_local_only: "Learning data is stored on this device.",
    account_status_sync_ready: "Cloud sync is ready.",
    account_sign_in: "Sign in",
    account_sign_in_google: "Sign in with Google",
    account_sign_in_apple: "Sign in with Apple",
    account_sign_out: "Sign out",
    account_signing_in: "Signing in...",
    account_sign_in_coming_soon: "Sign in will be added next.",
    account_sync_ready: "Cloud sync is ready.",
    account_sync_checking: "Checking sync data...",
    account_sync_upload_detail: "Upload this device's learning data to the cloud.",
    account_sync_download_detail: "Download cloud learning data to this device.",
    account_sync_conflict_detail: "Choose which learning data to keep for the first sync.",
    account_sync_changed_detail: "Cloud data differs from this device. Choose which data to keep.",
    account_sync_check: "Check sync",
    account_sync_checking_short: "Checking",
    account_sync_up_to_date: "Up to date",
    account_sync_section_title: "Sync",
    account_sync_upload: "Upload device data",
    account_sync_download: "Download cloud data",
    account_sync_working: "Syncing...",
    account_sync_done: "Sync complete.",
...
de: {
    ...
    start_with_apple: "Mit Apple fortfahren",
    start_with_google: "Mit Google fortfahren",
    start_as_guest: "Als Gast starten",
    start: "Start",
    ...
    account_title: "Konto",
    account_status_guest: "Gastmodus",
    account_status_signed_in: "Angemeldet",
    account_status_local_only: "Lerndaten werden auf diesem Gerät gespeichert.",
    account_status_sync_ready: "Cloud-Sync ist bereit.",
    account_sign_in: "Anmelden",
    account_sign_in_google: "Mit Google anmelden",
    account_sign_in_apple: "Mit Apple anmelden",
    account_sign_out: "Abmelden",
    account_signing_in: "Anmeldung...",
    account_sign_in_coming_soon: "Anmeldung wird im nächsten Schritt hinzugefügt.",
    account_sync_ready: "Cloud-Sync ist bereit.",
    account_sync_checking: "Sync-Daten werden geprüft...",
    account_sync_upload_detail: "Lerndaten dieses Geräts in die Cloud hochladen.",
    account_sync_download_detail: "Cloud-Lerndaten auf dieses Gerät laden.",
    account_sync_conflict_detail: "Wähle die Lerndaten für die erste Synchronisierung.",
    account_sync_changed_detail: "Cloud-Daten unterscheiden sich von diesem Gerät. Wähle, welche Daten bleiben.",
    account_sync_check: "Sync prüfen",
    account_sync_checking_short: "Prüfung",
    account_sync_up_to_date: "Aktuell",
    account_sync_section_title: "Sync",
    account_sync_upload: "Gerätedaten hochladen",
    account_sync_download: "Cloud-Daten laden",
    account_sync_working: "Synchronisierung...",
    account_sync_done: "Synchronisierung abgeschlossen.",
    settings_feedback_title: "Feedback",
...
es: {
    ...
    start_with_apple: "Continuar con Apple",
    start_with_google: "Continuar con Google",
    start_as_guest: "Entrar como invitado",
    start: "Iniciar",
    ...
    account_status_guest: "Modo invitado",
    account_status_signed_in: "Sesión iniciada",
    account_status_local_only: "Los datos se guardan en este dispositivo.",
    account_status_sync_ready: "La sincronización está lista.",
    account_sign_in: "Iniciar sesión",
    account_sign_in_google: "Entrar con Google",
    account_sign_in_apple: "Entrar con Apple",
    account_sign_out: "Cerrar sesión",
    account_signing_in: "Iniciando sesión...",
    account_sign_in_coming_soon: "El inicio de sesión se añadirá después.",
    account_sync_ready: "La sincronización está lista.",
    account_sync_checking: "Comprobando datos...",
    account_sync_upload_detail: "Sube los datos de este dispositivo a la nube.",
    account_sync_download_detail: "Descarga los datos de la nube a este dispositivo.",
    account_sync_conflict_detail: "Elige qué datos conservar para la primera sincronización.",
    account_sync_changed_detail: "Los datos de la nube son distintos. Elige qué datos conservar.",
    account_sync_check: "Comprobar sync",
    account_sync_checking_short: "Comprobando",
    account_sync_up_to_date: "Actualizado",
    account_sync_section_title: "Sincronización",
    account_sync_upload: "Subir datos del dispositivo",
    account_sync_download: "Descargar datos de la nube",
    account_sync_working: "Sincronizando...",
    account_sync_done: "Sincronización completa.",
...
fr: {
    ...
    start_with_apple: "Continuer avec Apple",
    start_with_google: "Continuer avec Google",
    start_as_guest: "Continuer en invité",
    start: "Commencer",
    ...
    account_status_guest: "Mode invité",
    account_status_signed_in: "Connecté",
    account_status_local_only: "Les données restent sur cet appareil.",
    account_status_sync_ready: "La synchronisation est prête.",
    account_sign_in: "Se connecter",
    account_sign_in_google: "Google",
    account_sign_in_apple: "Apple",
    account_sign_out: "Se déconnecter",
    account_signing_in: "Connexion...",
    account_sign_in_coming_soon: "La connexion sera ajoutée ensuite.",
    account_sync_ready: "La synchronisation est prête.",
    account_sync_checking: "Vérification des données...",
    account_sync_upload_detail: "Envoyer les données de cet appareil vers le cloud.",
    account_sync_download_detail: "Télécharger les données du cloud sur cet appareil.",
    account_sync_conflict_detail: "Choisis les données à garder pour la première synchronisation.",
    account_sync_changed_detail: "Les données cloud diffèrent de cet appareil. Choisis les données à garder.",
    account_sync_check: "Vérifier sync",
    account_sync_checking_short: "Vérification",
    account_sync_up_to_date: "À jour",
    account_sync_section_title: "Sync",
    account_sync_upload: "Envoyer les données",
    account_sync_download: "Télécharger le cloud",
    account_sync_working: "Synchronisation...",
    account_sync_done: "Synchronisation terminée.",
...
it: {
    ...
    start_with_apple: "Continua con Apple",
    start_with_google: "Continua con Google",
    start_as_guest: "Continua come ospite",
    start: "Inizia",
    ...
    account_title: "Account",
    account_status_guest: "Modalità ospite",
    account_status_signed_in: "Accesso effettuato",
    account_status_local_only: "I dati restano su questo dispositivo.",
    account_status_sync_ready: "La sincronizzazione cloud è pronta.",
    account_sign_in: "Accedi",
    account_sign_in_google: "Accedi con Google",
    account_sign_in_apple: "Accedi con Apple",
    account_sign_out: "Esci",
    account_signing_in: "Accesso in corso...",
    account_sign_in_coming_soon: "L'accesso sarà aggiunto dopo.",
    account_sync_ready: "La sincronizzazione cloud è pronta.",
    account_sync_checking: "Controllo dei dati...",
    account_sync_upload_detail: "Carica i dati di questo dispositivo nel cloud.",
    account_sync_download_detail: "Scarica i dati cloud su questo dispositivo.",
    account_sync_conflict_detail: "Scegli quali dati usare per la prima sincronizzazione.",
    account_sync_changed_detail: "I dati cloud sono diversi da questo dispositivo. Scegli quali mantenere.",
    account_sync_check: "Controlla sync",
    account_sync_checking_short: "Controllo",
    account_sync_up_to_date: "Aggiornato",
    account_sync_section_title: "Sync",
    account_sync_upload: "Carica dati dispositivo",
    account_sync_download: "Scarica dati cloud",
    account_sync_working: "Sincronizzazione...",
    account_sync_done: "Sincronizzazione completata.",
    settings_feedback_title: "Feedback",
...
pt: {
    ...
    start_with_apple: "Continuar com Apple",
    start_with_google: "Continuar com Google",
    start_as_guest: "Continuar como convidado",
    start: "Iniciar",
    ...
    settings_language_title: "Idioma",
    account_title: "Conta",
    account_status_guest: "Modo convidado",
    account_status_signed_in: "Conectado",
    account_status_local_only: "Os dados ficam neste dispositivo.",
    account_status_sync_ready: "A sincronização está pronta.",
    account_sign_in: "Entrar",
    account_sign_in_google: "Entrar com Google",
    account_sign_in_apple: "Entrar com Apple",
    account_sign_out: "Sair",
    account_signing_in: "Entrando...",
    account_sign_in_coming_soon: "O login será adicionado depois.",
    account_sync_ready: "A sincronização está pronta.",
    account_sync_checking: "Verificando dados...",
    account_sync_upload_detail: "Envie os dados deste dispositivo para a nuvem.",
    account_sync_download_detail: "Baixe os dados da nuvem para este dispositivo.",
    account_sync_conflict_detail: "Escolha quais dados manter na primeira sincronização.",
    account_sync_changed_detail: "Os dados da nuvem diferem deste dispositivo. Escolha quais manter.",
    account_sync_check: "Verificar sync",
    account_sync_checking_short: "Verificando",
    account_sync_up_to_date: "Atualizado",
    account_sync_section_title: "Sincronização",
    account_sync_upload: "Enviar dados do dispositivo",
    account_sync_download: "Baixar dados da nuvem",
    account_sync_working: "Sincronizando...",
    account_sync_done: "Sincronização concluída.",
    settings_feedback_title: "Feedback",
...
ja: {
    ...
    start_with_apple: "Appleで続ける",
    start_with_google: "Googleで続ける",
    start_as_guest: "ゲストで始める",
    start: "スタート",
    ...
    account_title: "アカウント",
    account_status_guest: "ゲストモード",
    account_status_signed_in: "ログイン済み",
    account_status_local_only: "学習データはこの端末に保存されます。",
    account_status_sync_ready: "クラウド同期の準備ができました。",
    account_sign_in: "ログイン",
    account_sign_in_google: "Googleでログイン",
    account_sign_in_apple: "Appleでログイン",
    account_sign_out: "ログアウト",
    account_signing_in: "ログイン中...",
    account_sign_in_coming_soon: "ログインは次の段階で追加されます。",
    account_sync_ready: "クラウド同期の準備ができました。",
    account_sync_checking: "同期データを確認中...",
    account_sync_upload_detail: "この端末の学習データをクラウドにアップロードします。",
    account_sync_download_detail: "クラウドの学習データをこの端末に取り込みます。",
    account_sync_conflict_detail: "初回同期で使う学習データを選んでください。",
    account_sync_changed_detail: "クラウドとこの端末のデータが異なります。残すデータを選んでください。",
    account_sync_check: "同期を確認",
    account_sync_checking_short: "確認中",
    account_sync_up_to_date: "最新",
    account_sync_section_title: "同期",
    account_sync_upload: "端末データをアップロード",
    account_sync_download: "クラウドデータを取得",
    account_sync_working: "同期中...",
    account_sync_done: "同期完了。",
...
zh: {
    ...
    start_with_apple: "使用 Apple 继续",
    start_with_google: "使用 Google 继续",
    start_as_guest: "以访客身份开始",
    start: "开始",
    ...
    account_title: "账户",
    account_status_guest: "访客模式",
    account_status_signed_in: "已登录",
    account_status_local_only: "学习数据保存在此设备上。",
    account_status_sync_ready: "云同步已准备好。",
    account_sign_in: "登录",
    account_sign_in_google: "使用 Google 登录",
    account_sign_in_apple: "使用 Apple 登录",
    account_sign_out: "退出登录",
    account_signing_in: "正在登录...",
    account_sign_in_coming_soon: "登录将在下一步添加。",
    account_sync_ready: "云同步已准备好。",
    account_sync_checking: "正在检查同步数据...",
    account_sync_upload_detail: "将此设备的学习数据上传到云端。",
    account_sync_download_detail: "将云端学习数据下载到此设备。",
    account_sync_conflict_detail: "请选择首次同步要保留的学习数据。",
    account_sync_changed_detail: "云端数据与此设备不同。请选择要保留的数据。",
    account_sync_check: "检查同步",
    account_sync_checking_short: "检查中",
    account_sync_up_to_date: "已是最新",
    account_sync_section_title: "同步",
    account_sync_upload: "上传设备数据",
    account_sync_download: "下载云端数据",
    account_sync_working: "正在同步...",
    account_sync_done: "同步完成。",
...
ru: {
    ...
    start_with_apple: "Продолжить с Apple",
    start_with_google: "Продолжить с Google",
    start_as_guest: "Продолжить как гость",
    start: "Начать",
    ...
    account_status_guest: "Гостевой режим",
    account_status_signed_in: "Вход выполнен",
    account_status_local_only: "Данные хранятся на этом устройстве.",
    account_status_sync_ready: "Облачная синхронизация готова.",
    account_sign_in: "Войти",
    account_sign_in_google: "Войти через Google",
    account_sign_in_apple: "Войти через Apple",
    account_sign_out: "Выйти",
    account_signing_in: "Вход...",
    account_sign_in_coming_soon: "Вход будет добавлен позже.",
    account_sync_ready: "Облачная синхронизация готова.",
    account_sync_checking: "Проверка данных...",
    account_sync_upload_detail: "Загрузить данные этого устройства в облако.",
    account_sync_download_detail: "Скачать данные из облака на это устройство.",
    account_sync_conflict_detail: "Выберите данные для первой синхронизации.",
    account_sync_changed_detail: "Данные в облаке отличаются от этого устройства. Выберите, что оставить.",
    account_sync_check: "Проверить sync",
    account_sync_checking_short: "Проверка",
    account_sync_up_to_date: "Актуально",
    account_sync_section_title: "Синхронизация",
    account_sync_upload: "Загрузить данные устройства",
    account_sync_download: "Скачать данные из облака",
    account_sync_working: "Синхронизация...",
    account_sync_done: "Синхронизация завершена.",
